<template>
  <div id="MainLayout" class="w-full fixed z-50">
    <div id="TopMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
      ...
      >
        <li
          class="border-r border-r-gray-400 px-3 hover:text-green-400 cursor-pointer"
        >
          Sell On Our Website
        </li>
        <li
        ...
        <li
          ...
          class="relative flex items-center px-2.5 hover:text-green-400 h-full cursor-pointer"
          :class="
            isAccountMenu
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      ...
      >
        ...
        <div class="max-w-[700px] w-full md:block hidden">
          <div class="relative">
            ...
            >
              ...
              />
              <button
                class="flex items-center h-[100%] p-1.5 px-2 bg-green-400"
              >
        ...
        <NuxtLink to="/shoppingcart" class="flex items-center">
          ...
          >
            <span
              class="absolute flex items-center justify-center -right-[3px] top-0 bg-green-400 h-[17px] min-w-[17px] text-xs text-white px-0.5 rounded-full"
            >
              0
            </span>

    ...
    <div class="my-auto">
      ...
      >
        <div
          ...
          :class="[
            isHover ? 'border-[#4ade80]' : 'border-gray-300',
            isSelected ? 'bg-[#4ade80]' : '',
          ]"
        >
    ...
    <div class="overflow-hidden pl-2 w-full">
      <div class="flex items-center justify-between w-full">
        <div class="flex items-center justify-between truncate">
          <span
            class="sm:block hidden bg-red-300 text-white text-[9px] font-semibold px-1.5 rounded-sm min-w-[80px]"
            >Welcome Deal</span
          >
      ...
      <div class="flex items-center justify-end">
        <button
          @click="removeFromCart()"
          class="sm:hidden block -mt-0.5 hover:text-green-400"
        >
          <Icon name="material-symbols:delete-outline" size="20" />
        </button>
      </div>
